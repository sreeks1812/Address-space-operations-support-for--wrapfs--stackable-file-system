...
extern const struct address_space_operations wrapfs_aops, wrapfs_dummy_aops,wrapfs_mmap_aops;
...
struct wrapfs_sb_info {
	...
	//mount option to check fi the mmap option is enabled or not
	unsigned char mmap_set;
	#ifdef WRAPFS_CRYPTO

	//key to encrypt and decrypt the files
